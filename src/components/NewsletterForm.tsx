...
export const NewsletterForm: React.FC<Porps> = ({ formID = '3572924' }) => {
  return (
    <form action={`https://app.convertkit.com/forms/${formID}/subscriptions`} method="post" className="flex flex-wrap -mx-2">
